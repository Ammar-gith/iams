    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Newspaper Periodicity</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class="card-header text-success">
                        <li class="fa fa-align-justify"></li> Newspaper
                    </h5>
                    <a href="{{ route('newspaperPeriodicity.create') }}" class="btn btn-success">+ New Periodicity</a>
                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('newspaperPeriodicity.edit', $newspaper_periodicity->id) }}">
