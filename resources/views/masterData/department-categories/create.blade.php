    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">New Department Category</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
            ...
            <div class="card mb-4">
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class=" card-header  text-success">
                        <li class="fa fa-align-justify"></li> New Department Category
                    </h5>
                </div>
                <hr>
                <form action="{{ route('departmentCategory.store') }}" method="POST" class="card-body" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-footer col-md-12 d-flex justify-content-end align-items-center g-5">
                        <a href="{{ route('departmentCategory.index') }}" type="button" class="btn btn-secondary">Cancel</a>
                        &nbsp;&nbsp;&nbsp;
