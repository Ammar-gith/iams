    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">New Ad Rejection Reason</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
            ...
            <div class="card mb-4">
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class=" card-header  text-success">
                        <li class="fa fa-align-justify"></li> New Ad Rejection Reason
                    </h5>
                </div>
                <hr>
                <form action="{{ route('adRejectionReason.store') }}" method="POST" class="card-body"
                    ...
                    <div class="row mb-3 mx-5  ">
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" id="collapsible-address" rows="2"
