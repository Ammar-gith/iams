    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Ad Rejection Reasons</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class="card-header text-success">
                        <li class="fa fa-align-justify"></li> Ad Rejection Reasons
                    </h5>
                    <a href="{{ route('adRejectionReason.create') }}" class="btn btn-success">+ New Ad Rejection Reason</a>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($ad_rejection_reasons as $ad_rejection_reason)
                                <tr>
                                    <td>{{ $ad_rejection_reason->id }}</td>
                                    <td style="width:50%">{{ $ad_rejection_reason->description }}</td>
                                    {{-- @php
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('adRejectionReason.edit', $ad_rejection_reason->id) }}">
