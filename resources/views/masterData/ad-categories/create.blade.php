    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">New Category</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <hr>
                <form action="{{ route('adCategory.store') }}" method="POST" class="card-body" enctype="multipart/form-data">
                    @csrf
