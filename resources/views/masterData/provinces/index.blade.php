    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Provinces</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class="card-header text-success">
                        <li class="fa fa-align-justify"></li> Provinces
                    </h5>
                    <a href="{{ route('province.create') }}" class="btn btn-success">+ New Province</a>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($provinces as $province)
                                <tr>
                                    <td>{{ $province->id }}</td>
                                    <td>{{ $province->code }}</td> <!-- Serial Number -->
                                    <td>{{ $province->name }}</td>
                                    {{-- @php
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{ route('province.edit', $province->id) }}">
