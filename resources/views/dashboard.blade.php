...
@push('style')
    <style>
        ...
        color: #1a936f; /* Active text color */
        background-color: #eaf6f1; /* Active background color */
        font-weight: bold;
        }

        .filter-menu-link .badge {
        ...
        .filter-menu-link.active .badge {
        background-color: #1a936f; /* Active badge background */
        color: #fff; /* Active badge text color */
        }
        ...
        .filter-menu-link:hover .badge {
        background-color: #ddd;
        }

        .filter-menu-link::after {
        content: "";
        position: absolute;
        bottom: -2px;
        left: 0;
        ...
        .filter-menu-link.active::after {
        transform: scaleX(1);
        }

        .filter-menu-link:hover::after {
        transform: scaleX(1);
        }
