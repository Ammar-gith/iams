            ...
            <div class="card mb-4">
                ...
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class="card-header text-success">
                        <li class="fa fa-align-justify"></li> Adv Agencies
                    </h5>
                    <a href="{{ route('advAgency.create') }}" class="btn btn-success">+ New Adv Agency</a>
                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('advAgency.edit', $adv_agency->id) }}">
